...
/**
 * Created by ahmed aj on 03/05/2018.
 */
...
class CandidateCard(private val homeRectFrag: HomeRectFrag,private val mContext:Context, private val mSwipeView: SwipePlaceHolderView, var t: Candidate,val id:String) {
...
lateinit  var idCandAcceptedList:ArrayList<CandItemAcceptedList>
    ...
    init{
        ...
        candidateViewModel= ViewModelProviders.of(homeRectFrag).get(CandidateCardViewModel::class.java)
    }
    ...
    private fun onSwipedOut() {
        ...
        candidateViewModel.ChangeCandOfferStatus(t._id,OfferInCandReject)!!.observe(homeRectFrag,object: Observer<Candidate> {
        ...
        candidateViewModel.ChangeOfferCandetat(id, candofferetaatRejected)!!.observe(homeRectFrag,object: Observer<Offer> {
    ...
    private fun onSwipeIn() {
        ...
        candidateViewModel.ChangeOfferCandetat(id,candofferetaat)!!.observe(homeRectFrag,object: Observer<Offer> {
            override fun onChanged(t: Offer?) {
                Log.d("cange cand etat","in offer with sucess")
            }
        })
        candidateViewModel.ChangeCandOfferStatus(t._id,acceptedOfferInCand)!!.observe(homeRectFrag,object:Observer<Candidate>{
            override fun onChanged(t: Candidate?) {
