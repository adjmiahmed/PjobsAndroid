...
import com.internship.ahmedaj.tinderstage.View.UI.Activity.Fragments.AllOffreFrag
...
class OfferAllCards(private val frag: AllOffreFrag, private val mContext: Context, private val mSwipeView: SwipePlaceHolderView, var t: Offer, var id:String) {
